...
var snapshotsResource = schema.GroupVersionResource{Group: "shahpratikr.dev", Version: "v1alpha1", Resource: "snapshots"}

var snapshotsKind = schema.GroupVersionKind{Group: "shahpratikr.dev", Version: "v1alpha1", Kind: "Snapshot"}
